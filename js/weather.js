...
async function fetchWeatherData() {
    try {
        // Use a CORS proxy to avoid CORS issues on GitHub Pages
        const corsProxy = 'https://corsproxy.io/?';
        const apiUrl = `https://api.open-meteo.com/v1/forecast?latitude=${PERTH_LAT}&longitude=${PERTH_LON}&current=temperature_2m,relative_humidity_2m,apparent_temperature,weather_code,wind_speed_10m&timezone=Australia%2FPerth`;
